from UTN_Heroes_Dataset import matriz_data_heroes
...
def utn_mostrar_cantidad_heroes_femeninos():



    pass

def utn_mostrar_cantidad_heroes_masculinos():
    pass 

def utn_mostrar_heroes_mas_75_poder():
    pass
